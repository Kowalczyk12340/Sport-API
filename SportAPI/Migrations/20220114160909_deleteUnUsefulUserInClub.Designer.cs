...
namespace SportAPI.Migrations
{
    ...
    [Migration("20220114160909_deleteUnUsefulUserInClub")]
    partial class deleteUnUsefulUserInClub
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportAPI.Sport.Models.CoachCourse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("CoachCourse", "Sport");
                });

            modelBuilder.Entity("SportAPI.Sport.Models.Course", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SportAPI.Sport.Models.CoachCourse", b =>
                {
                    b.HasOne("SportAPI.Sport.Models.Coach", "Coach")
                        .WithMany("CoachCourses")
                        .HasForeignKey("CoachId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportAPI.Sport.Models.Course", "Course")
                        .WithMany("CoachCourses")
